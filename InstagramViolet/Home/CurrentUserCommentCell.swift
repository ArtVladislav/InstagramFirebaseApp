...
class CurrentUserCommentCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        imageView.anchor(top: topAnchor, leading: nil, trailing: trailingAnchor, bottom: nil, paddingTop: 4, paddingLeading: 0, paddingTrailing: -10, paddingBottom: 0, width: 46, height: 46)
